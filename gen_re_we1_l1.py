...
# space = {
#         'TAU': hp.uniform('TAU', 0,5), 'EPS': hp.uniform('EPS', 0,5)}  ####'lambda': hp.uniform('lambda', 0,1),
...
# f = open("Gen_Re_We_l1/logs1/Gen1_L1 measurement {} sparsity {}.txt".format(m, args.sparsity), "w")
# # f.write('Lamda is {}\n'.format( lam))
# # f.write('gamma is {}\n'.format( gam))
